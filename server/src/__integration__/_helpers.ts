...
const TABLES_TO_WIPE: readonly string[] = [
  'lingxios.agent_model_budget_calls',
  'lingxios.agent_model_budgets',
  'lingxios.lecture_checkpoints',
  'lingxios.lecture_decks',
  'lingxios.agent_claim_requests',
  'lingxios.agent_routine_runs',
  'lingxios.agent_routines',
  'lingxios.agent_os_session_leases',
  'lingxios.agent_os_session_routes',
  'lingxios.agent_os_workers',
  'lingxios.agent_request_snapshots',
  'lingxios.agent_os_sessions',
  'lingxios.agent_run_events',
  'lingxios.agent_action_resolutions',
  'lingxios.agent_action_ledger',
  'lingxios.agent_action_intents',
  'lingxios.agent_delivery_outbox',
  'lingxios.agent_calendar_outbox',
  'lingxios.agent_canvas_outbox',
  'lingxios.agent_document_outbox',
  'lingxios.agent_messages',
  'lingxios.agent_memory_embeddings',
  'lingxios.agent_memory_versions',
  'lingxios.agent_memory_evidence',
  'lingxios.agent_memories',
  'lingxios.agent_inbox_events',
  'lingxios.agent_work_items',
  'lingxios_ingress_outbox',
