...
const TABLES_TO_WIPE: readonly string[] = [
  ...
  'lingxios.agent_approvals',
  'lingxios.agent_results',
  ...
  'lingxios.agent_evolution_benchmarks',
  'lingxios.agent_evolution_evaluations',
  'lingxios.agent_memory_embeddings',
  'lingxios.agent_memory_versions',
  'lingxios.agent_memory_evidence',
  'agent_native_event_outbox',
  'canvas_agent_runs',
  'agent_routine_runs',
  'agent_routines',
