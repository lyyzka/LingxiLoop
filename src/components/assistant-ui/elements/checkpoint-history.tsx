...
import { conversationCardSize, mono, paper } from "./surfaces";
...
> & {
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="px-1.5 pb-1 text-[13.5px] font-medium">检查点</span>
          ...
          >
            ...
            <span className="flex min-w-0 flex-1 flex-col">
              ...
              <span className={cn(mono, "text-foreground/30")}>
                {checkpoint.at} · {checkpoint.items} 项
              </span>
            </span>
            ...
            {current ? (
              ...
              <button
                type="button"
                aria-label={`恢复到${checkpoint.label}`}
