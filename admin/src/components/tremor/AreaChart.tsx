// Adapted for LingxiLoop: shared utilities, Lucide icons, Recharts 3 and accessibility.
...
import { ChevronLeft as RiArrowLeftSLine, ChevronRight as RiArrowRightSLine } from "lucide-react"
import {
  Area,
  CartesianGrid,
  Dot,
        ...
        <ResponsiveContainer minWidth={0}>
          ...
          >
            ...
            <XAxis
              ...
              ticks={
                startEndOnly
                  ? data.length ? [data[0][index], data[data.length - 1][index]] : []
                  : undefined
              }
              fill=""
              stroke=""
            ...
            {categories.map((category, categoryIndex) => {
              const categoryId = `${areaId}-${categoryIndex}`
              return (
