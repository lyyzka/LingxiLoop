  ...
  (
    ...
    return (
      <div
        ...
        {...other}
      >
        <ResponsiveContainer className="size-full" minWidth={0}>
          <ReChartsDonutChart
            accessibilityLayer
            onClick={
          ...
          >
            ...
            <Pie
              ...
              shape={(props: any) => activeIndex !== undefined && props.index !== activeIndex ? renderInactiveShape(props) : <Sector {...props} />}
              style={{ outline: "none" }}
            />
            {showTooltip && (
              <Tooltip
