/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/control-plane/wrangler.jsonc` (hash: acb02cf22bf3e9a9815b1315f6770dfb)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/control-plane/src/index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN_BASE_URL" | "OPENSHIP_BASE_URL" | "UPTIME_BASE_URL" | "OPENSHIP_PROJECT_IDS" | "OPENSHIP_IMAGE_TARGETS" | "AUTH_ALLOWED_HOSTS" | "APP_VERSION">> {}
}
